			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						_reactRouter.Route,
						{ path: "/", components: _header2.default },
						_react2.default.createElement(_reactRouter.IndexRoute, { getComponent: function getComponent(nextState, cb) {
								return __webpack_require__.e/* nsure */(1, function (require) {
									return cb(null, __webpack_require__(270).default);
								});
							} }),
						_react2.default.createElement(_reactRouter.Route, { path: "/roomList/:id", getComponent: function getComponent(nextState, cb) {
								return __webpack_require__.e/* nsure */(2, function (require) {
									return cb(null, __webpack_require__(537).default);
								});
							} }),
						_react2.default.createElement(_reactRouter.Route, { path: "/myCalendar", getComponent: function getComponent(nextState, cb) {
								return __webpack_require__.e/* nsure */(3, function (require) {
									return cb(null, __webpack_require__(539).default);
								});
							} })
					)
				);
...
/***/ function(module, exports, __webpack_require__) {
		...
		_createClass(Header, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'wrap pos_re clearfix' },
						_react2.default.createElement(
							...
							this.props.children && _react2.default.cloneElement(this.props.children, { key: _this.props.location.pathname })
						)
					)
				);
			}
	...
	var ConnectApp = (0, _reactRedux.connect)(function (state) {
		return state;
	})(Header);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer3 = __webpack_require__(543);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialState = {
		result: [{ roomNum: 101, name: "海景房", price: 380, enable: true }, { roomNum: 305, name: "山景房", price: 350, enable: true }, { roomNum: 8203, name: "阳光房", price: 260, enable: true }, { roomNum: 603, name: "主题房", price: 280, enable: true }]
	};
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("C:\\Users\\user\\Documents\\redux_demo\\test3\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "reducer2.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
