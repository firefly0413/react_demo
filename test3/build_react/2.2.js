webpackJsonp([2],Array(282).concat([
/* 282 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _alert = __webpack_require__(538);
	...
	var roomList = function (_Component) {
		...
		_createClass(roomList, [{
			key: "render",
			value: function render() {
				var results = this.props.roomList;
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"button",
						{ className: "btn btn-default btn-sm", onClick: this.popAlert.bind(this) },
						"错误"
					),
					_react2.default.createElement(
						"div",
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								"div",
								null,
								"\"this.props.location.state.roomSku\":  ",
								this.props.location.state.roomSku
							),
							_react2.default.createElement(
								"div",
						...
						_react2.default.createElement(_alert2.default, { ref: "alertComp" })
					)
				);
			}
		}, {
			...
			value: function popAlert() {
				var str = "这是个错误弹窗!";
				this.refs["alertComp"].handleAlertShow(str);
			}
		}]);
	...
	exports.default = (0, _reactRedux.connect)(theState)(roomList);

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("C:\\Users\\user\\Documents\\redux_demo\\test3\\node_modules\\react-hot-loader\\makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "roomList.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AlertComp = _react2.default.createClass({
	  displayName: "AlertComp",
	  getInitialState: function getInitialState() {
	    return {
	      alertVisible: false
	    };
	  ...
	  handleAlertShow: function handleAlertShow(data) {
	    this.setState({
	      errorMsg: data,
	      alertVisible: true
	    });
